...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Editando Marca {{ $car_models->title }}</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('car_model.update', $car_models->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="card-body">
                                    ...
                                    <select class="form-control @error('car_brand_id') is-invalid @enderror"
                                        ...
                                        @foreach ($car_brands as $car_brand)
                                            <option value="{{ $car_brand->id }}"
                                                {{ $car_models->car_brand_id == $car_brand->id ? 'selected' : '' }}>
